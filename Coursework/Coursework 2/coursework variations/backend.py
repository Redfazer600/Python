...
# Base smart device with self.switched on and appropriate accessor / mutator methods other devices inherit.
class SmartDevice:
    def __init__(self):
...
class SmartPlug(SmartDevice):
    ...
    def setConsumptionRate(self, consumption):
        consumption = str(consumption)  # Sets to string since every given input can be converted and validated easily
        while True:
