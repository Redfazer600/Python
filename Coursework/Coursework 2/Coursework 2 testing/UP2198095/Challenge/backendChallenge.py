...
# Smart Device superclass with a self.switchedOn value that gets inherited as do the methods
class SmartDevice:
    def __init__(self):
...
# Task 1 - Smart Plug
class SmartPlug(SmartDevice):   # Subclass of SmartDevice
...
class SmartDoorBell(SmartDevice):       # Subclass of SmartDevice
    def __init__(self):
        super().__init__()
